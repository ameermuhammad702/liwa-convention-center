    ...
    <section id="contact" className="py-24 bg-charcoal-light" ref={ref}>
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3930.0!2d76.6!3d10.0!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zM0hIOCtXViBOZWxsaWt1emhpLCBLZXJhbGE!5e0!3m2!1sen!2sin!4v1700000000000&q=3HH8%2BWV+Nellikuzhi,+Kerala"
              width="100%"
              height="100%"
